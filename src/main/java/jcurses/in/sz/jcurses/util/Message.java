package jcurses.in.sz.jcurses.util;

import jcurses.in.sz.jcurses.event.ActionEvent;
import jcurses.in.sz.jcurses.event.ActionListener;
import jcurses.in.sz.jcurses.widgets.Button;
import jcurses.in.sz.jcurses.widgets.Label;
import jcurses.in.sz.jcurses.widgets.DefaultLayoutManager;
import jcurses.in.sz.jcurses.widgets.Dialog;
import jcurses.in.sz.jcurses.widgets.WidgetsConstants;
...
public class Message  extends Dialog implements ActionListener  {
    ...
    */
	...
	private static int getWidth(String label, String title) {
		...
		if (result> jcurses.in.sz.jcurses.system.Toolkit.getScreenWidth()-3) {
			result= jcurses.in.sz.jcurses.system.Toolkit.getScreenWidth()-3;
		}
