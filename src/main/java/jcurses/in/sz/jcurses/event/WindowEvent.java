package jcurses.in.sz.jcurses.event;

import jcurses.in.sz.jcurses.widgets.Window;
/**
...
public class WindowEvent extends Event {
    ...
    * @param type the type of the event, must be equal to one of four following constants:
