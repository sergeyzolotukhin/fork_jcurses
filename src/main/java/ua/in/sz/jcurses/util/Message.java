package ua.in.sz.jcurses.util;

import ua.in.sz.jcurses.event.ActionEvent;
import ua.in.sz.jcurses.event.ActionListener;
import ua.in.sz.jcurses.widgets.Button;
import ua.in.sz.jcurses.widgets.Label;
import ua.in.sz.jcurses.widgets.DefaultLayoutManager;
import ua.in.sz.jcurses.widgets.Dialog;
import ua.in.sz.jcurses.widgets.WidgetsConstants;
import ua.in.sz.jcurses.widgets.Window;
...
public class Message  extends Dialog implements ActionListener  {
    ...
    */
	...
	private static int getWidth(String label, String title) {
		...
		if (result>ua.in.sz.jcurses.system.Toolkit.getScreenWidth()-3) {
			result=ua.in.sz.jcurses.system.Toolkit.getScreenWidth()-3;
		}
